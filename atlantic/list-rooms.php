...
$.ajax({
    url: "http://localhost/traveloworld/atlantic/public/index.php/rooms/all/"+startDate+"/"+endDate+"/"+minAmt+"/"+maxAmt,
    method: 'GET',
...
Available: https://www.w3schools.com/jquery/tryit.asp?filename=tryjquery_html_append2. [Accessed On: 23rd June 2018].*/
    ...
    for (var i=0; i <= data.length-1; i++) {	
        ...
        $("ol").append("<li><div class='container list-room'><div class='row'><div class='col-md-3'>"+image+"</div><div class='col-md-7'><h3>Room Type"+roomType+"<hr/><p>"+description+"</p><p>"+room+"</p></div><div class='col-md-2'><h2>CAD"+price+"</h2><a href='single-room.php?id="+id+"&startDate="+startDate+"&endDate="+endDate+"' class='btn-primary btn-rooms'>Book this Room</a></div></div></div></li><br />");
    }    
