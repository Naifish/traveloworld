...
Available: https://www.w3schools.com/jquery/tryit.asp?filename=tryjquery_html_append2. [Accessed On: 23rd June 2018].*/
    ...
    for (var i=0; i <= data.length-1; i++) {	
        ...
        $("ol").append("<li><div class='container'><center><div class='room-img'>"+image+"</div></center><br/><br/><h2>Room Type "+roomType+"</h2><hr/><h3>Description</h3><p>"+description+"</p><h3>Room Number </h3><p>"+room+"</p><div class='row'><div class='col-md-3'><h3>Start Date  </h3>"+startDate+"</div><div class='col-md-3'><h3> End Date </h3> "+endDate+"</div></div><br /><h2>CAD "+price+"</h2><br/><a href='payment.php?id="+id+"' class='btn-primary btn-rooms'>Book this Room</a></div></li><br />");
    }    
